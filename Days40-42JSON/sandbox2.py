...
state_info = state_choice(state)

climbing_areas = state_info[1]
zip_codes = state_info[2]

together = zip(climbing_areas, zip_codes)
...
with open('temp.csv', mode='w') as write_file:
    ...
    employee_writer.writerow(['Climbing_Areas', 'Zip_codes'])
    
    for i in together:
        employee_writer.writerow([i[0], i[1]])
